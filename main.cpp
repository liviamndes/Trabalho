...
int main() {
    ...
    cout << "Bem-vinda, " << jogador.getNome() << "!\n";

    // 2. Definir Cenário Bosque das Fadas (FASE 1)
    cout << "\n--- Fase 1: Bosque das Fadas ---\n";
    ...
    ClareiraCorrompida clareira{missaoClareira, semente, fungo};
    ...
    LagodasLagrimas lago{missaoLago, cristalAgua, almas};
